...
public class FrmConsultaDisponibles extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger =
        java.util.logging.Logger.getLogger(FrmConsultaDisponibles.class.getName());

    public FrmConsultaDisponibles() {
        initComponents();
        cargar();
    }
    ...
    private void cargar() {
        try {
            ...
            m.setRowCount(0);
            List<Vehiculo> lista = new VehiculoDAO().listarDisponibles();
            ...
            lblTotal.setText("Disponibles: " + lista.size());
    ...
    private void initComponents() {
        ...
        lblTotal.setText("Disponibles: 0");
        lblTotal.setFont(new java.awt.Font("Segoe UI", 1, 12));
        lblTotal.setForeground(new java.awt.Color(0, 150, 0));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() { new FrmConsultaDisponibles().setVisible(true); }
        });
    }
