/*
 * Consulta de Vehículos por Marca
 */
package VISUAL;
...
public class FrmConsultaMarca extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger =
        java.util.logging.Logger.getLogger(FrmConsultaMarca.class.getName());
    ...
    private void BtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarActionPerformed
        ...
        if (marca.isEmpty()) { cargarTodos(); return; }
        try {
            List<Vehiculo> lista = new VehiculoDAO().buscarPorMarca(marca);
            poblarTabla(lista);
            if (lista.isEmpty()) JOptionPane.showMessageDialog(this, "No se encontraron vehículos con esa marca.");
        } catch (Exception e) { logger.warning(e.getMessage()); }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() { new FrmConsultaMarca().setVisible(true); }
        });
    }
