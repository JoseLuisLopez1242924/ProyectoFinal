...
public class FrmConsultaVehiculos extends javax.swing.JFrame {
    ...
    public FrmConsultaVehiculos() {
        initComponents();
        cargarGamas();
        ejecutarConsulta(); // mostrar todos al abrir
    }

    // Llena el combo de gamas con los IDs existentes
    ...
    // Columnas estándar para la tabla de resultados
    private static final String[] COLS = {
        "Matrícula", "Marca", "Modelo", "Tipo Veh.", "Motor",
        "Gama", "Descripción", "Color", "Status"
    };
    ...
    private void initComponents() {
        ...
        // ---- Panel Disponibles (sin filtro) ----
        jLabelDisp = new javax.swing.JLabel("Muestra todos los vehículos disponibles (no rentados).");
        pnlDisponibles.add(jLabelDisp);

        // ---- Panel Rentados (sin filtro) ----
        jLabelRent = new javax.swing.JLabel("Muestra todos los vehículos actualmente rentados.");
